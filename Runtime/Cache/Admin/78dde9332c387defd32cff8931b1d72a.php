        ...
        <section>
            ...
            <ul class="ulColumn2">
                <li>
                    ...
                    <input type="text" name="title" id="title" class="textbox textbox_295" value="<?php echo ($news["title"]); ?>" placeholder="新闻标题..." required="true" />
                </li>
                <li>
                    <span class="item_name" style="width:120px;vertical-align:top;">简介：</span>
                    <textarea placeholder="新闻简介..." id="remark" class="textarea" style="width:600px;height:100px;" name="remark"><?php echo ($news["remark"]); ?></textarea>
                </li>
                ...
                <li>
                    ...
                    <label class="single_selection">
                        <div style="width: 320px;height: 200px;border:1px solid #eee;"><img id="showbox" src="<?php echo ($news["image"]); ?>" style="width: 100%;" /></div>
                    </label> 
                    <input type="hidden" id="showboxurl" name="image" value="<?php echo ($news["image"]); ?>">
                </li>
                <li>
                    <span class="item_name" style="width:120px;">新闻正文：</span>
                    <script id="editor" name="content" type="text/plain"><?php echo (htmlspecialchars_decode($news["content"])); ?></script>
                </li>
