 ...
 <div class="rt_content">
      ...
      <form action="" method="get">
        ...
        <section style="margin:15px;">
          ...
          <a href="<?php echo U('Index/addadmin');?>" id="addMan">添加管理员</a>
     ...
     <section>
      ...
      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr class="dataList">
              ...
              <td>
                <?php if($value['name'] != C('ADMIN')): ?><a href="<?php echo U('Index/updateadmin',array('id'=>$value['id']));?>"><span class="v_update">修改</span></a>
