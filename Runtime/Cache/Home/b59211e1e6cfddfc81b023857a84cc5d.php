...
<div>
		  ...
		  <div class="logo_right">
		  	  <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="<?php echo U('Index/join');?>" class="active">招商加盟</a></li>
	...
	<!--banner end-->
	<div class="head_bar">
		<span>位置：</span><a href="<?php echo U('Index/index');?>">首页 </a> > <span class="active">招商加盟</span>
	</div>
	<div class="comfor_con">
		<div class="top_tit">
			<span class="span1"><a href="<?php echo U('Index/join');?>">招商加盟</a></span><br />
			<span class="span2">COMFORTABLE RESIDENTIAL</span>
		</div>
		<div class="zx_fang">
			<div class="f_da wow bounceIn">
				<div><img src="/Public/images/zsjm.jpg" alt="" /><i></i></div>
			</div>
		</div>
	</div>
