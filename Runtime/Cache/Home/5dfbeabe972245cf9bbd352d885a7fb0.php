...
<div>
		  ...
		  <div class="logo_right">
		  	  <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="<?php echo U('Index/news');?>" class="active">新闻动态</a>
		   				<ul>
	...
	<section class="banner_zi">
	    <div><img src="/Public/images/banner_com.png" alt=""></div>
	</section>
	<!--banner end-->
	<div class="head_bar">
		<span>位置：</span><a href="<?php echo U('Index/index');?>">首页 </a> > <span class="active">品牌荣誉</span>
	</div>
	<div class="comfor_con">
		<div class="top_qie">
			<a href="<?php echo U('Index/news');?>" >公司新闻</a>
			<a href="#" >行业新闻</a>
			<a href="<?php echo U('Index/notice');?>" class="active">企业公告</a>
		</div>
		<div class="zx_fang">
			<span class="zx_span">云返汽车企业公告</span>
			<div class="f_da wow bounceIn">
				<div><img src="/Public/images/gg2.jpg" alt="" /><i></i></div>
				<div><img src="/Public/images/gg2.jpg" alt="" /><i></i></div>
				<div><img src="/Public/images/gg2.jpg" alt="" /><i></i></div>
				...
				<div><img src="/Public/images/fa_da1.jpg" alt="" /><i></i></div>
				<div><img src="/Public/images/fa_da2.jpg" alt="" /><i></i></div>
				<div><img src="/Public/images/about2-4.jpg" alt="" /><i></i></div>
			</div>
			<div class="f_xiao">
				<div>
					<div class="pic">
						<img src="/Public/images/gg2.jpg" alt="" /><i></i>
					</div>
					<a href="">1</a>
				</div>
				<div>
					...
					<a href="" style="text-align: center">我是企业最高荣誉</a>
					
				</div>
				<div>
					<div class="pic">
						<img src="/Public/images/about2-2.jpg" alt="" /><i></i>
					</div>
					<a href="">3</a>
				</div>
				<div>
					<div class="pic">
						<img src="/Public/images/about2-5.jpg" alt="" /><i></i>
					</div>
					<a href="">4</a>
				</div>
				<div>
					<div class="pic">
						<img src="/Public/images/fa_xiao2.png" alt="" /><i></i>
					</div>
					<a href="">5</a>
				...
				<div>
					<div class="pic">
						<img src="/Public/images/fa_xiao3.png" alt="" /><i></i>
					</div>
					<a href="">6</a>
				</div>
				<div>
					<div class="pic">
						<img src="/Public/images/fa_xiao1.png" alt="" /><i></i>
					</div>
					<a href="">7</a>
				</div>
				<div>
				...
				<div class="nei">
					<div class="">
						<ul class="di_nav clearfix">
							<li><a href="<?php echo U('Index/infuncar');?>">云返汽车</a></li>
							<li><a href="court_travel.html">关于我们</a></li>
							<li><a href="<?php echo U('Index/join');?>">招商加盟</a></li>
	...
	<nav id="mmenu">
		...
		<ul>
			...
			<li><a href="<?php echo U('Index/index');?>" class="active">首页</a></li>
   			<li><a href="<?php echo U('Index/infuncar');?>">云返汽车</a></li>
   			<li><a href="<?php echo U('Index/about');?>l">关于我们</a>
            	<ul>
		   					<li><a href="<?php echo U('Index/about');?>">企业概况</a></li>
		   					<li><a href="#">发展历程</a></li>
		   					<li><a href="#">品牌形象</a></li>
