...
<head>
    ...
    <title>云返汽车</title>
    <meta name="keywords" content="云返汽车">
    <meta name="description" content="云返汽车">
...
<div>
    ...
    <section class="banner">
        <div><a href="<?php echo U('Index/index');?>"><img src="/Public/images/banner2.jpg" alt=""></a></div>
        <div><a href="<?php echo U('Index/index');?>"><img src="/Public/images/banner2.jpg" alt=""></a></div>
        <div><a href="<?php echo U('Index/index');?>"><img src="/Public/images/banner2.jpg" alt=""></a></div>
    </section>
    <!--banner end-->
        ...
        <div class="news_com">
            ...
            <div class="news_nei clearfix">
                <div class="n_left  wow bounceInLeft">
                    <div class="imgd">
                        <a href="#"><img src="/Public/images/new-top.jpg" alt="" class="vcenter" /></a>
                        <i></i>
                        <span class="ri">
                            <i>08</i>
                            <time>2018.28</time>
                    ...
                    <h4><a href="#">云返汽车深入浙江腹地 迎来宁波云返汽车城盛大启航</a></h4>
                    <p>
                        适逢国内汽车市场的快速发展，浙江的汽车产业影响力逐渐凸显出来，吸引了无数汽车品牌或经销商的进驻……
                    </p>
                    <a href="<?php echo U('Index/news');?>" class="more">查看更多>></a>
                </div>
                <div class="n_right">
                    <ul>
                        <li class="clearfix wow bounceInRight"  data-wow-delay="0.5s">
                            ...
                            <span class="ri">
                                ...
                                <div class="wen_nei">
                                    <h4>云付通集团“海岛生存”特训营圆满举办</h4>
                                    <p>7月7日—8日，历时两天的云付通集团高管“海岛生存”特训营取得圆满落幕。本次培训集合了集团总部、各产业平台的高管人员六十多人参与，在深圳大甲岛训练基地开启了一次脱胎换骨...</p>
                                </div>
                            </a>
                        </li>
                        <li class="clearfix wow bounceInRight"  data-wow-delay="1s">
                            ...
                            <span class="ri">
                                ...
                                <div class="wen_nei">
                                    <h4>营口云返汽车城盛大开业，有望为东北发展注入新活力!</h4>
                                    <p>为加快落实“百城百店”战略目标，2018年云返汽车聚势发力，高歌猛进布局全国市场，7月5日在辽宁省营口市成立全国第44家...</p>
                                </div>
                            </a>
                        </li>
                        <li class="clearfix wow bounceInRight"  data-wow-delay="1.5s">
                            ...
                            <span class="ri">
                                ...
                                <div class="wen_nei">
                                    <h4>西北地区再扩版图，兰州云返汽车城隆重开业</h4>
                                    <p>6月26日，兰州云返汽车销售有限公司开业庆典在甘肃省兰州市安宁区北滨河西路兰州云返汽车城隆重举行。云返汽车全国副总经理陈凤女士、云返汽车全体授权人及全国各级合伙人莅临兰州云返...</p>
                                </div>
                            </a>
                        </li>
                        <li class="clearfix wow bounceInRight"  data-wow-delay="2.5s">
                            <a href="#">
                            <span class="ri">
                                <i>25</i>
                                <time>2016-02</time>
    ...
    <div class="home_pro">
        <div class="pro_nei">
            <div class="top_all">
                <h3>产品展示</h3>
                <span>TRUELANG&PRODUCT</span> 
            </div>
            <div class="pro_com clearfix">
                <div class="p_left wow bounceInLeft">
                    <img src="/Public/images/carbig.png" alt="" class="vcenter" />
                    <i></i>
                    <a href="#" class="zhe_a slideExpandUp">
                        <img src="/Public/images/lian.png" alt="" />
                        <span class="zw">兰博基尼在此</span>
                        <span class="yw">AMMONIA VICTORIA LE ®4</span>                      
                    </a>
                </div>
                <div class="p_right wow bounceInRight">
                    <ul class="clearfix">
                        <li>
                            <div class="pic">
                                <img src="/Public/images/car-small-02.jpg" alt=""class="vcenter" />
                                <i></i>
                            </div>
                            <a href="#" class="zhe_a slideExpandUp">
                                <img src="/Public/images/lian.png" alt="" />
                                <span class="zw">画册宣传册</span>
                                <span class="yw">AMMONIA VICTORIA LE ®4</span>
                            </a>
                        </li>   
                        <li>
                            <div class="pic">
                                <img src="/Public/images/car-small-03.jpg" alt=""class="vcenter" />
                                <i></i>
                            </div>
                            <a href="#" class="zhe_a slideExpandUp">
                                <img src="/Public/images/lian.png" alt="" />
                        ...
                        <li>
                            <div class="pic">
                                <img src="/Public/images/car-small-04.jpg" alt=""class="vcenter" />
                                <i></i>
                            </div>
                            <a href="#" class="zhe_a slideExpandUp">
                                <img src="/Public/images/lian.png" alt="" />
            ...
            <div class="con">
                <div class="nei">
                    <div class="">
                        ...
                        <li><a href="<?php echo U('Index/index');?>">云返汽车</a></li>
                    ...
                    <div class="lian">
                        ...
                        邮箱：<a href="">yunfanqiche3@163.com</a><br />
        ...
        <ul>
            ...
            <li><a href="<?php echo U('Index/news');?>">新闻动态</a>
                <ul>
                    <li><a href="<?php echo U('Index/news');?>">公司新闻</a></li>
                    <!-- <li><a href="#">行业新闻</a></li> -->
                    <li><a href="<?php echo U('Index/honor');?>">企业公告</a></li>
                </ul>
            </li>
            <li><a href="<?php echo U('Index/feedback');?>">留言中心</a></li>
            <li><a href="<?php echo U('Index/contact');?>">联系我们</a></li>
