...
<script type="text/javascript">
	...
	map.centerAndZoom(new BMap.Point(113.3763,22.972473), 17);  // 初始化地图,设置中心点坐标和地图级别
	map.enableScrollWheelZoom(true);     //开启鼠标滚轮缩放
	var point = new BMap.Point(113.3763,22.972473);
...
//	var infoWindow = new BMap.InfoWindow("云返汽车城", opts);  // 创建信息窗口对象
