...
<div>
		  ...
		  <div class="logo_right">
		  	  <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="<?php echo U('Index/about');?>"  class="active">关于我们</a>
		   				<ul>
	...
	<div class="comfor_con">
		<div class="top_qie">
			<a href="<?php echo U('Index/about');?>">企业概况</a>
			<a href="" >发展历程</a>
			<a href="" >品牌形象</a>
			<a href="<?php echo U('Index/honor');?>" class="active">品牌荣誉</a>
		</div>
		<div class="zx_fang">
			<span class="zx_span">云返汽车荣誉榜</span>
			<div class="f_da wow bounceIn">
				<div><img src="images/about2-1.jpg" alt="" /><i></i></div>
				<div><img src="images/about2-2.jpg" alt="" /><i></i></div>
				<div><img src="images/about2-5.jpg" alt="" /><i></i></div>
				...
				<div><img src="images/fa_da1.jpg" alt="" /><i></i></div>
				<div><img src="images/fa_da2.jpg" alt="" /><i></i></div>
				<div><img src="images/about2-4.jpg" alt="" /><i></i></div>
			</div>
			<div class="f_xiao">
				<div>
					<div class="pic">
						<img src="images/about2-4.jpg" alt="" /><i></i>
					</div>
					<a href="">1</a>
				</div>
				<div>
					<div class="pic">
						<img src="images/about2-1.jpg" alt="" /><i></i>
					</div>
				...
				<div>
					<div class="pic">
						<img src="images/about2-2.jpg" alt="" /><i></i>
					</div>
					<a href="">3</a>
				</div>
				<div>
					<div class="pic">
						<img src="images/about2-5.jpg" alt="" /><i></i>
					</div>
					<a href="">4</a>
				</div>
				<div>
