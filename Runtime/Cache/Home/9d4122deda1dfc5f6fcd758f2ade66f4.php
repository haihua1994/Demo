...
<div>
		  ...
		  <div class="logo_right">
		  	 <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="<?php echo U('Index/contact');?>"  class="active">联系我们</a></li>
		   		</ul>
		  	 </nav>
		  	 <div class="search">
		  	 	<span class="sea_x">
	...
	<section class="banner_zi">
	    <div><img src="/Public/images/banner_contact.png" alt=""></div>
	</section>
	<!--banner end-->
	<div class="head_bar">
		<span>位置：</span><a href="<?php echo U('Index/index');?>">首页 </a> > <span class="active">联系我们</span>
	</div>
		<div class="contact_con">
			<div class="top_tit">
				<span class="span1"><a href="<?php echo U('Index/contact');?>">联系我们</a></span><br />
				<span class="con_span">您好，如您有云返汽车的相关问题，可直接联系我们！</span>
			</div>
			<div class="nei clearfix">
				<div class="left">
					<a href="mailto:Eason.wang@71360.com"><img src="/Public/images/email.png" alt="" />yunfanqiche3@163.com</a>
					<a href=""><img src="/Public/images/phone.png" alt="" />020-39270000</a>
					<a href=""><img src="/Public/images/shouji.png" alt="" />400-900-4448</a>
					<span > <img src="/Public/images/weizhi.png" alt="" />广州市番禺区大北路555号云返汽车城</span>
				<a href="http://map.baidu.com/?newmap" target="_blank" class="ditu"><i class="fa fa-search"></i>查看地图</a>
				</div>
				<div class="right" style="width: 605px;height: 379px;position: absolute;top: 0;right: 0;">
					<div class="zi_right">
						<div class="contact_zi">
							<div class="map">
								<iframe style="width: 100%;height:379px;border: 2px dashed #ddd;" src="map.html"></iframe>
								<span>地图加载中...</span>
							</div>
						</div>
					</div>
