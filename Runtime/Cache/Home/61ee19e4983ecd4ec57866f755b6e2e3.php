...
<div>
		  ...
		  <div class="logo_right">
		  	  <nav class="nav">
		   		<ul>    
		   			...
		   			<li><a href="<?php echo U('Index/infuncar');?>"    class="active">云返汽车</a></li>
	...
	<section class="banner_zi">
	    <div><img src="/Public/images/banner_jing.png" alt=""></div>
	</section>
	<!--banner end-->
	<div class="head_bar">
		<span>位置：</span><a href="<?php echo U('Index/index');?>">首页 </a> > <span class="active">云返汽车</span>
	</div>

	<!-- 企业简介 -->
	<div class="home_about">
		<div class="about_com clearfix container">
			<div class="a_left wow bounceInLeft">
				<div class="ab_bg">
					<i></i>
				</div>
				<div class="pic">
					<img src="/Public/images/about.jpg" alt="" class="vcenter" />
					<i></i>
				</div>
			</div>
			<div class="a_right wow bounceInRight">
				...
				<p>
					广东云返汽车销售有限公司简称“云返汽车”，是一家以高科技为起点，创新型的汽车销售企业，是中国汽车销售企业的创新品牌，全国总部设在中国广州。
				</p>
				<p>
					云返汽车打破传统销售模式，以创新理念推出的购车消费模式，采用APP线上订车、线下提车，自2016年5月推出市场以来就深受全国消费者的欢迎和信赖...
				</p>
				<a href="<?php echo U('Index/about');?>" class="more">查看更多 →</a>
...
<!--合作伙伴-->
	<div class="hzhb">
		...
		<ul class="hzhb_ul clearfix">
			<li>
				<a href="">
					<img src="/Public/images/he1.jpg" alt="" class="vcenter"/><i></i>
				</a>
			</li>
			<li>
				<a href="">
					<img src="/Public/images/he2.jpg" alt=""  class="vcenter"/><i></i>
				</a>
			</li>
			<li>
				<a href="">
