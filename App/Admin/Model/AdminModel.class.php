...
class AdminModel extends Model
{
    ...
    {
        $field="a.id as id,a.name as name ,email,is_active,a.remark as remark,current_login_ip,current_login_time,c.name as rolename,b.role_id as role_id,m_count,prev_login_ip";
